...
- clean SEO dashboard layouts
- URL submission queues
- search result interface concepts
- crawler/discovery paths
- backlink graph concepts
...
- fake Google UI screenshots that imply official affiliation
- fake ranking guarantees
- "100% indexed" stamps or badges
...
Subject images should be simple product-adjacent objects or scenes:

- a URL queue flowing into search discovery
- a dashboard with submitted, pending, and discovered states
- a browser/search results abstraction
- backlink nodes connecting to indexed pages
- a desktop app window with a list of URLs
- a checklist with crawlability and submission steps

Subject images must not include:

- real Google logos
- real Search Console screenshots
- third-party logos unless licensed or explicitly approved
- exact unvalidated claims such as `15,000 sites`, `300 sites`, or `100% indexed`
...
Use the template that matches the article job:
