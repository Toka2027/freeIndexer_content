        ...
        rows.append(
            {
                ...
                "series_hub": meta.get("series_hub", ""),
                "previous_article": meta.get("previous_article", ""),
                "next_article": meta.get("next_article", ""),
                "icp": meta.get("icp", ""),
                "funnel_stage": meta.get("funnel_stage", ""),
                "intent": meta.get("intent", ""),
                "status": meta.get("meta.status", "draft"),
                "quality_score": meta.get("content_quality.score", ""),
