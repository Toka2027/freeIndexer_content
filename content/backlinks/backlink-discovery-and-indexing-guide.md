...
keywords:
  ...
  secondary:
    - backlink indexing
    - get backlinks discovered
    - backlink indexing workflow
    - index backlinks
    - backlink discovery guide
intent: informational-commercial
search_intent: "Learn how to help known backlinks and supporting URLs get discovered without using spammy backlink blast tactics."
...
meta:
  ...
  blog_tags:
    ...
    - content-discovery
  pillar: true
  cta: "Build a clean backlink discovery list, then submit the links that are worth tracking."
...
If you run affiliate campaigns, also read the [indexing workflow for affiliate sites](/indexing-workflow-for-affiliate-sites). Agencies can use the [agency indexing workflow](/url-indexing-for-seo-agencies) for client process design.

## Start With Known Links
...
### Can backlink indexing be promised?
...
### Is backlink discovery useful for affiliate SEO?
