...
keywords:
  ...
  secondary:
    - provider to indexing workflow
    - SEO campaign indexing
    - managed SEO discovery follow-up
...
meta:
  ...
  blog_tags:
    ...
    - content-discovery
  pillar: false
  cta: "Connect provider work to follow-up"
...
image:
  concept: "Provider-to-indexing workflow diagram with plan execute verify submit track report stages"
  hero_template: 2
---
